package com.FreeTech.apps.VPN1.Free_VPN_With_Servers.dialogs;
    ...
    * */
    public void onClick(View view) {
        ...
        if (id != R.id.text_view_submit) {
            ...
            this.activity.startActivity(new Intent("android.intent.action.VIEW", Uri.parse("https://play.google.com/store/apps/details?id=" + "com.FreeTech.apps.VPN1.Free_VPN_With_Servers")));
            dismiss();
