...
import com.FreeTech.apps.VPN1.Free_VPN_With_Servers.databinding.FragmentMenuBinding
import com.FreeTech.apps.VPN1.Free_VPN_With_Servers.dialogs.RateDialog
import com.FreeTech.apps.VPN1.Free_VPN_With_Servers.view.activites.SubscriptionActivity
import com.FreeTech.apps.VPN1.Free_VPN_With_Servers.view.activites.faq_activity
import com.FreeTech.apps.VPN1.Free_VPN_With_Servers.view.activites.loadingWebData
...
class MenuFragment : Fragment() {
    ...
    private fun showAboutDialog() {
        ...
        dialog.setContentView(com.FreeTech.apps.VPN1.Free_VPN_With_Servers.R.layout.dialog_about)
        ...
        (dialog.findViewById<View>(com.FreeTech.apps.VPN1.Free_VPN_With_Servers.R.id.bt_close) as RelativeLayout).setOnClickListener { dialog.dismiss() }
        dialog.show()
    ...
    private fun privacyPolicyLink() {
        ...
        webActivity.putExtra("webLink", resources.getString(com.FreeTech.apps.VPN1.Free_VPN_With_Servers.R.string.privacy_policy_link))
        startActivity(webActivity)
    }

    fun shareApp() {
        val msg = StringBuilder()
        msg.append(getString(com.FreeTech.apps.VPN1.Free_VPN_With_Servers.R.string.share_msg))
        msg.append("\n")
